package com.nandroidex.faceview
...
class CircularFaceView constructor(context: Context, attrs: AttributeSet?) :
    CircularImageView(context, attrs) {
    ...
    init {
        ...
        val ta = context.obtainStyledAttributes(attrs, R.styleable.FaceView)
        faceElevation = ta.getInt(R.styleable.FaceView_face_elevation, 10)
        ta.recycle()
    ...
    private fun initializeBitmap() {
        ...
        when (val drawable = drawable) {
            ...
            else -> bitmap = Bitmap.createBitmap(
